...
// daca dupa o varianta urmeaza mutarea negrului (ex. 6. ... Bb3), functia scrisa
// nu isi da seama ca ar urma mutarea lui

const jsonedGameCuBug = [
  {
    depth: 1,
    fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
    comment:
...
const Viewer = () => {
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-4 mb-4" tabIndex={0}>
      ...
      <div className="overflow-y-auto">{JSXedGame}</div>
    </div>
  );
};
